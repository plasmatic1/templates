...
data:
  ...
  bundledCode: "#line 1 \"tests/math/matrix_mul.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/matrix_product\"\
    \n#line 2 \"template.hpp\"\n#include <bits/stdc++.h>\nusing namespace std;\n\n\
    // Defines\n#define fs first\n#define sn second\n#define pb push_back\n#define\
    ...
    \ 6 \"tests/math/matrix_mul.test.cpp\"\n\nusing MI = ModInt<int, 998244353>;\n\
  ...
  verifiedWith: []
documentation_of: tests/math/matrix_mul.test.cpp
layout: document
redirect_from:
- /verify/tests/math/matrix_mul.test.cpp
- /verify/tests/math/matrix_mul.test.cpp.html
